...
//         })
        ...
        _updateImagesCustom: function(variant) {
			console.log("Custom Event");
          	var current_slide_index = $('.template-product .product-main-slider .slick-current').attr("data-slick-index");
          	var mainImage = $('.template-product .product-main-slider .image-gallery-main');    
  			var thumbImage = $('.template-product .thumbnail-gallery .thumbnail-slider .thumbnail-slider-inner');
          	var images = [];
        	...
        	var imgSet = variant.sku;
              ...
              dataType:'json',
          	  success:function(response){
                  ...
                  console.log(images);
                $(".meeting-rooms-features .center-col img").attr("src",images[1].url);
                    mainImage.empty();
                    thumbImage.empty();
                    ...
                    var arr = [];
                      ...
                      var MainSlide = "<div class='image-gallery-block'><div class='gallery-wrap'><img src='"+url+"' alt='"+alt+"' class='photoswipe__image lazyload'></div></div>"; 
                      var thumbSlide = "<div class='thumnail-gallery-block'><div class='thumbnail-wrap'><img src='"+url+"' alt='"+alt+"'></div></div>"; 
                     ...
                     $.when.apply($, arr).done(function () {
                       ...
                       $('.product-main-slider .image-gallery-main').slick('slickGoTo', current_slide_index);
                   });
    ...
    CartForm.prototype = Object.assign({}, CartForm.prototype, {
      ...
      cartMarkup: function(html) {
        ...
        if($("body").hasClass("template-cart")){
        	this.subtotalNew.innerHTML = theme.Currency.formatMoney(subtotalNew, theme.settings.moneyFormat);
        }
        this.reInit();
      ...
      updateSubtotal: function(subtotal) {
        ...
        this.form.querySelector(selectors.subTotalNew).innerHTML = theme.Currency.formatMoney(subtotal, theme.settings.moneyFormat);
      },
      ...
      updatePrice: function(evt) {
        ...
        if (variant) {
		  ...
		  // this.cache.price.innerHTML = theme.Currency.formatMoney(variant.price, theme.settings.moneyFormat);
			this.cache.price.innerHTML = "<span aria-hidden='true'>"+theme.Currency.formatMoney(variant.price, theme.settings.moneyFormat)+"</span><span class='visually-hidden'>"+theme.Currency.formatMoney(variant.price, theme.settings.moneyFormat)+"</span><span class='vat_text'> (Ex. VAT)</span>";

  
          // Sale price, if necessary
          if (variant.compare_at_price > variant.price) {
			//    this.cache.comparePrice.innerHTML = theme.Currency.formatMoney(variant.compare_at_price, theme.settings.moneyFormat);
			this.cache.comparePrice.innerHTML = "<span aria-hidden='true'>"+theme.Currency.formatMoney(variant.compare_at_price, theme.settings.moneyFormat)+"</span><span class='visually-hidden'>"+theme.Currency.formatMoney(variant.compare_at_price, theme.settings.moneyFormat)+"</span><span class='vat_text'> (Ex. VAT)</span>";
