!(function (t, e) {
            ...
            return (
              c.length > 1
                ? ((f = a.getAttribute("sizes") || ""),
                  (f = (l.test(f) && parseInt(f, 10)) || i.gW(t, t.parentNode)),
                  (c.d = h(t)),
                  !c.src || !c.w || c.w < f
                    ? ((c.w = f),
                      (u = (function (t) {
  ...
  (function (t, e) {
            ...
            e.widths.forEach(function (n) {
              var o = e.widthmap[n] || n,
                r = {
                  u: t
                    .replace(h, o)
                    .replace(p, e.ratio ? Math.round(n * e.ratio) : ""),
                  w: n,
                };
    ...
    var a,
      ...
      x = "srcset" in y && !("sizes" in y),
      b = !!t.HTMLPictureElement && !x;
    !(function () {
      var e,
        n = {
          prefix: "",
      ...
      addEventListener(
        ...
        function (t) {
          ...
          if (
            ...
            if (
              ((c = r(e, (n = s(e)))),
              (x = h.test(c.prefix) || h.test(c.postfix)),
              c.isPicture && (u = e.parentNode))
            )
              for (
                p = 0, f = (d = u.getElementsByTagName("source")).length;
                f > p;
                p++
              )
    ...
    var w = (function () {
      ...
      return (
        b ? (l = function () {}) : addEventListener("lazybeforesizes", l), l
      );
    })();
  }),
  (function (t, e) {
            ...
            var s,
              ...
              Z = function () {
                var t,
                  ...
                  g,
                  v = i.elements;
                if ((f = n.loadMode) && H < 8 && (t = v.length)) {
                  (r = 0),
                    B++,
                    null == N &&
                      ("expand" in n ||
              ...
              J = P(function (t, e, i, o, r) {
                ...
                (f = w(t, "lazybeforeunveil", e)).defaultPrevented ||
                  ...
                  (a = t[l](n.srcsetAttr)),
                  (s = t[l](n.srcAttr)),
                  r && (d = (c = t.parentNode) && p.test(c.nodeName || "")),
            ...
            return {
              _: function () {
                (m = r.now()),
                  ...
                  i.elements.length ? (Z(), D._lsFlush()) : X();
              },
              checkElems: X,
              unveil: Q,
            };
      ...
      var a,
        ...
        At = function (t, e, i, n, o) {
          (!bt || (o && o !== r.currItem)) &&
            ...
            (t[A] = y + e + "px, " + i + "px" + x + " scale(" + n + ")");
        },
        _t = function (t) {
          et &&
            (t &&
              (g > r.currItem.fitRatio
                ? bt || (Ke(r.currItem, !1, !0), (bt = !0))
                : bt && (Ke(r.currItem), (bt = !1))),
            At(et, dt.x, dt.y, g));
        },
        It = function (t) {
          t.container &&
        ...
        $t = {
                ...
                for (var n = 0; n < i; n++)
                  gt > 0
                    ? ((e = S.shift()),
                      (S[2] = e),
                      h++,
                      kt((h + 2) * mt.x, e.el.style),
                      r.setContent(e, u - i + n + 1 + 1))
                    : ((e = S.pop()),
                      S.unshift(e),
                      h--,
                      kt(h * mt.x, e.el.style),
                      r.setContent(e, u + i - n - 1 - 1));
                if (et && 1 === Math.abs(gt)) {
                  var o = We(C);
          ...
          updateSize: function (e) {
            ...
            (v = g = r.currItem.initialZoomLevel),
              (tt = r.currItem.bounds) &&
                ((dt.x = tt.center.x), (dt.y = tt.center.y), _t(!0)),
              Dt("resize");
          },
        ...
        De = function (t) {
          ...
          return (
            _
              ...
              ? t.touches &&
                t.touches.length > 0 &&
                ((Ee[0] = xe(t.touches[0], Se)),
                t.touches.length > 1 && (Ee[1] = xe(t.touches[1], Ce)))
              : ((Se.x = t.pageX),
                (Se.y = t.pageY),
                (Se.id = ""),
                (Ee[0] = Se)),
        ...
        Ie = function (t) {
          ...
          if (
            ...
            if ((Yt(), V || (V = ke()), V.calculateSwipeSpeed("x"), B)) {
              ...
              it ||
                ("swipe" === n ? !K && g > r.currItem.fitRatio && Te(V) : Fe());
            }
        },
        ke = function () {
          var t,
              ...
              function () {
                if ((Dt("initialZoom" + (n ? "Out" : "In")), n)) {
                  var i = l.w / e.w,
                    ...
                    c = function (e) {
                      1 === e
                        ? ((g = i), (dt.x = l.x), (dt.y = l.y - N))
                        : ((g = (i - s) * e + s),
                          (dt.x = (l.x - r.x) * e + r.x),
                          (dt.y = (l.y - N - r.y) * e + r.y)),
                        _t(),
                        f ? (t.style.opacity = 1 - e) : zt(a - e * a);
                    };
                  p
                    ? Kt("initialZoom", 0, 1, d, o.easing.cubic.out, c, h)
                    : (c(1), (Ne = setTimeout(h, d + 20)));
                } else
                  (g = e.initialZoomLevel),
                    Lt(dt, e.initialPosition),
                    _t(),
                    zt(1),
                    f ? (t.style.opacity = 1) : zt(1),
                    (Ne = setTimeout(h, d + 20));
              },
              n ? 25 : 90
            ));
        },
            ...
            return (
              (function (t, e, i) {
                ...
                (n.center.x = Math.round((Be.x - e) / 2)),
                  ...
                  (n.max.y =
                    i > Be.y ? Math.round(Be.y - i) + t.vGap.top : n.center.y),
        ...
        publicMethods: {
          ...
          setContent: function (t, e) {
            ...
            if (l) {
              ...
              Ue || e !== u ? It(l) : ((et = c.style), He(l, n || l.img)),
                (t.el.innerHTML = ""),
                t.el.appendChild(c);
            } else t.el.innerHTML = "";
          },
          ...
          publicMethods: {
            ...
            handleMouseWheel: function (t) {
              if (g <= r.currItem.fitRatio)
                return (
                  s.modal &&
                    (!s.closeOnScroll || Zt || q
                      ? t.preventDefault()
                      : A && Math.abs(t.deltaY) > 2 && ((c = !0), r.close())),
                  !0
                );
        ...
        e.extend(t.options, E, !0),
          ...
          (function () {
            ...
            d("onVerticalDrag", function (t) {
              S && t < 0.95
                ? b.hideControls()
                : !S && t >= 0.95 && b.showControls();
            }),
              d("onPinchClose", function (e) {
                S && e < 0.9
                  ? (b.hideControls(), (t = !0))
                  : t && !S && e > 0.9 && b.showControls();
              }),
          ...
          S && t.currItem
            ? (b.updateIndexIndicator(),
              g.captionEl &&
                ...
                z(o, "caption--empty", !t.currItem.title)),
              (w = !0))
            : (w = !1),
            C || I(),
            A();
  ...
  (function (t, e) {
    ...
    function G(e, i, n) {
            ...
            o.addEventListener("keydown", function (t) {
              return (function (t, e) {
                ...
                if ((t.preventDefault(), h || d)) {
                  ...
                  if (null === v) return !1;
                  !1 === v &&
                    (v = D.getDefaultStep(z[e], d, i.keyboardDefaultStep)),
                    (u || c) && (v *= m),
                    (v = Math.max(v, 1e-7)),
                    (v *= d ? -1 : 1),
                    (a = P[e] + v);
      ...
      function U(t, e) {
        return (
          ...
          F(t.firstChild, i.cssClasses.tooltip)
        );
      }
      function R() {
        ...
        return (
          ...
          n.forEach(function (i, r) {
            ...
            for (
              ...
              for (
                g = (p = (h = D.toStepping(u)) - c) / (e.density || 1),
                  y = p / (v = Math.round(g)),
                  d = 1;
                d <= v;
                d += 1
              ...
              if ((s = n ? n(r, s) : s) !== t.PipsType.None) {
                ...
                (l.className = p(s, i.cssClasses.marker)),
                  ...
                  s > t.PipsType.NoValue &&
                    (((l = F(a, !1)).className = p(s, i.cssClasses.value)),
      ...
      function at(t, e, n, o, r, s) {
        ...
        return (
          d.length > 1 &&
            ...
            (o &&
              e > 0 &&
              ((a = D.getAbsoluteDistance(t[e - 1], i.margin, !1)),
              (n = Math.max(n, a))),
            r &&
              e < d.length - 1 &&
              ((a = D.getAbsoluteDistance(t[e + 1], i.margin, !0)),
              (n = Math.min(n, a)))),
          d.length > 1 &&
            i.limit &&
            (o &&
              e > 0 &&
              ((a = D.getAbsoluteDistance(t[e - 1], i.limit, !1)),
              (n = Math.min(n, a))),
            r &&
              e < d.length - 1 &&
              ((a = D.getAbsoluteDistance(t[e + 1], i.limit, !0)),
              (n = Math.max(n, a)))),
          i.padding &&
            (0 === e &&
              ((a = D.getAbsoluteDistance(0, i.padding[0], !1)),
              (n = Math.max(n, a))),
            e === d.length - 1 &&
              ((a = D.getAbsoluteDistance(100, i.padding[1], !0)),
              (n = Math.min(n, a)))),
        ...
        return (
          ...
          !1 !== e &&
            ((function (t, e) {
              ...
              (d[t].style[i.transformRule] = n), pt(t), pt(t + 1);
            })(t, e),
            !0)
        );
      }
      ...
      function ft(t, e) {
        return null === t || !1 === t || void 0 === t
          ...
          : ("number" == typeof t && (t = String(t)),
            !1 !== (t = i.format.from(t)) && (t = D.toStepping(t)),
            !1 === t || isNaN(t) ? z[e] : t);
      }
      function mt(t, e, n) {
        var o = u(t),
      ...
      h((y = S), i.cssClasses.target),
        ...
        x.tap && K(b.start, a, it, {}),
        x.hover && K(b.move, a, nt, { hover: !0 }),
        x.drag &&
    ...
    var K = { __spectrum: b, cssClasses: S, create: Y };
    (t.create = Y),
      (t.cssClasses = S),
      (t.default = K),
